...
const CarForm = ({ onSuccess }: { onSuccess?: () => void }) => {
  ...
  const carMutation = useMutation({
    mutationFn: async (values: Prisma.CarCreateInput) => await addCar(values),
    onSuccess: () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    carMutation.mutate(values as unknown as Prisma.CarCreateInput);
  }
